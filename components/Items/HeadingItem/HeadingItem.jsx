...
export default function HeadingItem(itemList) {
  return (
    <ItemCard id="heading-item" name="Heading" text={<HeadingItemText />} itemList={itemList}>
      <div className={styles.itemExampleContainer}>
        <div className={styles.text}>
          &lt;h1&gt;Detta är ett länkelement&lt;/h1&gt; &lt;h2&gt;Detta är ett länkelement&lt;/h2&gt; &lt;h3&gt;Detta är
          ett länkelement&lt;/h3&gt; &lt;h4&gt;Detta är ett länkelement&lt;/h4&gt; &lt;h5&gt;Detta är ett
