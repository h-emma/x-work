...
export default function AnimationItemText() {
  return (
    <p>
      A text about animation, consectetur adipiscing elit. Quisque auctor ipsum eget mollis sollicitudin. Pellentesque
      id tortor non eros condimentum placerat. Etiam aliquet magna id libero viverra, id ullamcorper erat hendrerit. In
      hac habitasse platea dictumst. Curabitur ullamcorper laoreet sodales. Nulla quis malesuada nulla. Cras vitae
      interdum tortor. Nam blandit semper consectetur.
      <br />
      <br />
