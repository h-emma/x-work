...
export default function ColorContrastItemText() {
  return (
    <>
      <p>
        Färgkontrast är en stor del av att tillgängliggöra en hemsida. För att
        underlätta läsningen för användare med till exempel färgblindhet är det
        ...
        test som har 18.5px och är bold samt 24px och större är kraven på nivå
        AA 3.1 i kontrast och för AAA 4:5.1. Dessa riktlinjer gäller inte
        dekorativa texter och logotyper. Gällande färgkontraster på delar som
        inte är text så som formulär behöver ration vara mellan 3 till 1.
      </p>
      <p>
        På webben finns det en del verktyg som underlättar testning av
        färgkontraster och deras ratio. Ett sådant verktyg är WebAIM’s{""}
