...
export default function ButtonItem() {
  return (
    <p>
      ...
      vanliga element, komponenter samt andra saker som kan vara bra att tänka på och hur dessa kan kodas för att
      förbättra tillgängligheten. Under <i>Om tillgänglighet</i> finns det mer att läsa om varför ämnet är viktigt, vad
      som är bra att tänka på vid skapande av en tillgänglig webb samt länkar till mer information om ämnet.
    </p>
  );
}
